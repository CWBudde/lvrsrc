...
func IsHeapScalarTag(tag int32) bool {
	...
	case int32(heap.FieldTagActiveDiag),
		...
		int32(heap.FieldTagFpgaImplementation),
		...
		int32(heap.FieldTagIndex),
		int32(heap.FieldTagInplace),
		int32(heap.FieldTagInstrStyle),
		int32(heap.FieldTagLastSignalKind),
		int32(heap.FieldTagMasterPart),
		int32(heap.FieldTagMaxWordLength),
		int32(heap.FieldTagMouseWheelSupport),
		int32(heap.FieldTagNVisItems),
		int32(heap.FieldTagObjFlags),
		int32(heap.FieldTagOutputInstanceNumberFromP),
		int32(heap.FieldTagOverflow),
		int32(heap.FieldTagOverride),
		int32(heap.FieldTagPaneFlags),
		int32(heap.FieldTagParmIndex),
		int32(heap.FieldTagParForIndexDistribution),
		int32(heap.FieldTagParForNumStaticWorkers),
		int32(heap.FieldTagPartID),
		int32(heap.FieldTagPrimIndex),
		int32(heap.FieldTagPrimResID),
		int32(heap.FieldTagQuantize),
		int32(heap.FieldTagRefListLength),
		int32(heap.FieldTagRsrcID),
		int32(heap.FieldTagSelectNRightType),
		int32(heap.FieldTagSelectSelLabFlags),
		int32(heap.FieldTagShortCount),
		int32(heap.FieldTagState),
		int32(heap.FieldTagTermListLength),
		int32(heap.FieldTagTunnelType),
		int32(heap.FieldTagWinFlags):
		return true
	default:
